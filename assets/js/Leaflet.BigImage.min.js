...
! function (t, e) {
    ...
    t.Control.BigImage = t.Control.extend({
        ...
        _createControl: function (e, i, n, o, s) {
            this._container = document.createElement("div"), this._container.id = "print-container", this._container.classList.add("leaflet-bar"), this._container.addEventListener("wheel", t.DomEvent.stop), this._containerParams = document.createElement("div"), this._containerParams.id = "print-params", this._containerParams.style.display = "none", this._createCloseButton();
            let a = document.createElement("h6");
            return a.style.width = "100%", a.innerHTML = this.options.inputTitle, this._containerParams.appendChild(a), this._createScaleInput(), this._createDownloadButton(), this._container.appendChild(this._containerParams), this._createControlPanel(n, s, e, i, o), t.DomEvent.disableScrollPropagation(this._container), t.DomEvent.disableClickPropagation(this._container), this._container
        },
        _createDownloadButton: function () {
            this._downloadBtn = document.createElement("div"), this._downloadBtn.classList.add("download-button"), this._downloadBtn = document.createElement("div"), this._downloadBtn.classList.add("download-button"), this._downloadBtn.innerHTML = this.options.downloadTitle, this._downloadBtn.addEventListener("click", () => {
                ...
                !t || t < this.options.minScale || t > this.options.maxScale ? this._scaleInput.value = this.options.minScale : (this._containerParams.classList.add("print-disabled"), this._loader.style.display = "block", this._print())
            }), this._containerParams.appendChild(this._downloadBtn)
        },
        _createScaleInput: function () {
            this._scaleInput = document.createElement("input"), this._scaleInput.style.width = "100%", this._scaleInput.type = "number", this._scaleInput.min = this.options.minScale, this._scaleInput.max = this.options.maxScale, this._scaleInput.id = "scale", this._scaleInput.name = "scale", this._containerParams.appendChild(this._scaleInput)
        },
        ...
        _createControlPanel: function (e, i, n, o, s) {
            ...
            a.innerHTML = n, a.id = "print-btn", a.setAttribute("title", o), e.forEach(function (t) {
                a.classList.add(t)
            }), t.DomEvent.on(a, "click", s, i), this._container.appendChild(a), this._controlPanel = a, this._loader = document.createElement("div"), this._loader.id = "print-loading", this._container.appendChild(this._loader)
        },
        ...
        _getMarkerLayer: function (e, i) {
            ...
            if (o = o.subtract(new t.Point(n.bounds.min.x, n.bounds.min.y)), e.options.icon && e.options.icon.options && e.options.icon.options.iconAnchor && (o.x -= e.options.icon.options.iconAnchor[0], o.y -= e.options.icon.options.iconAnchor[1]), n._pointPositionIsNotCorrect(o)) i();
            else {
                let t = new Image;
                t.crossOrigin = "Anonymous", t.onload = function () {
                    n.markers[e._leaflet_id] = {
                        img: t,
                        x: o.x,
                        y: o.y
                    }, i()
        ...
        _getPathLayer: function (e, i) {
            let n = this,
                o = 0,
                s = [];
            !e._mRadius && e._latlngs ? ((e.options.fill ? e._latlngs[0] : e._latlngs).forEach(e => {
        ...
        _drawPath: function (t) {
            ...
            }), t.closed && e.ctx.closePath(), this._feelPath(n)
        },
        ...
        _print: function () {
            ...
            t.zoom = t._map.getZoom(), t.bounds = t._map.getPixelBounds(), t.canvas = document.createElement("canvas"), t.canvas.width = e.x, t.canvas.height = e.y, t.ctx = t.canvas.getContext("2d"), this._changeScale(document.getElementById("scale").value), new Promise(function (e, i) {
                t._getLayers(e)
                ...
                }), t._containerParams.classList.remove("print-disabled"), t._loader.style.display = "none"
            })
        }
